...
class ClientCreate (BaseModel):
    ...
    password: str = Field(..., min_length=12, max_length=255, description="Senha do cliente")
...
class ClientUpdate (BaseModel):
    ...
    password: Optional[str] = Field(None, min_length=12, max_length=255, description="Senha do cliente")
